...
function search(query){
    switch(query.substr(0, 2)){
		...
		case "-ka": //Kiss Anime
           query = query.substr(3);
           window.location =
              "http://kissanime.to/Search/Anime/" +
               query.replaceChars(" ", "%20");
            break;
		...
		case "-t": //Twitter
           ...
           window.location =
              "https://twitter.com/search?q=" +
               query.replaceChars(" ", "%20") + "&src=typd";
            break;
			
		case "-tl": //Twitter Live
           query = query.substr(3);
           window.location =
		...
		case "-p": //ThePirateBay
           query = query.substr(3);
           window.location =
              "https://pirateproxy.red/search/" +
               query.replaceChars(" ", "%20") + "/0/99/0";
            break;
